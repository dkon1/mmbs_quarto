...
![Scanning electron micrograph of a dividing *Escherichia coli* bacteria (image by Evangeline Sowers, Janice Haney Carr (CDC) in public domain via Wikimedia Commons)](images/Ecoli_dividing.png){fig-align="left"}
...
![Growth of a population that doubles every generation over 6 generations](images/ch1_exp_growth.png)


![Decay of a population in which half the individuals die every time step over 6 generations](images/ch1_exp_decay.png)
