...
![Slope of $x$-nullcline (in blue) determines the stability of the fixed point; the negative slope of the function $f(x)$ creates an stable fixed point.](images/nullclines_neg_slope.png)
...
![Phase portrait of the glycolysis model (nullclines for $x$ and $y$ shown in orange and pink): with a stable fixed point.](images/glycolytic_stable.png)
...
trajectory converging to a limit cycle.](images/glycolytic_cycle.png)
...
![Stable fixed point in the Fitzhugh-Nagumo model.](images/lec16_fn_stable.png)

![Unstable fixed point in the Fitzhugh-Nagumo model.](images/lec16_fn_unstable.png)
